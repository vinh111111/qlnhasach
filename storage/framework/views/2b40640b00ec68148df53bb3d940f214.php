      ...
      <div class="wrapper">
            ...
            <div class="iq-navbar-custom">
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="iq-search-bar">
                     <form action="<?php echo e(route('admin.supplierearch')); ?>" method="get" class="searchbox">
                        <?php echo csrf_field(); ?>
         ...
         </div><?php /**PATH C:\xampp\htdocs\qlnhasach\resources\views/admin/suppliers/layout/header.blade.php ENDPATH**/ ?>