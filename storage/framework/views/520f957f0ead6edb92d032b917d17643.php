...
<?php $__env->startSection('content2'); ?>
                  ...
                  <div class="col-sm-12">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           <form action="<?php echo e(route('admin.postAuthorAdd')); ?>" method="post" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
      ...
      <!-- Footer -->
      <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.authors.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\qlnhasach\resources\views/admin/authors/admin-add-author.blade.php ENDPATH**/ ?>