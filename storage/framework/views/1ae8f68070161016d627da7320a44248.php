   ...
   <body>
      ...
      <div class="wrapper">
               ...
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     <li class="active active-menu">
                        <a href="<?php echo e(route('getHomepage')); ?>" class="iq-waves-effect" ><span class="ripple rippleEffect"></span><i class="las la-home iq-arrow-left"></i><span>Trang Chủ</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                     ...
                     <li>
                        ...
                        <?php if($type_book): ?>
                           <?php $__currentLoopData = $type_book; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li class="elements">
                                 <a href="<?php echo e(route('getTypebook',$type->id)); ?>"><i class="ri-play-circle-line"></i><span><?php echo e($type->name); ?></span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                              </li>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>                                             
                        </ul>
                     </li>
                     <li><a href="<?php echo e(route('getContact')); ?>"><i class="ri-question-answer-line"></i>Liên hệ</a></li>
                  </ul>
               </nav>
            </div>
         </div>
                                 ...
                                 <div class="iq-sub-dropdown iq-user-dropdown">
                                    <div class="iq-card shadow-none m-0">
                                       <div class="iq-card-body p-0 ">
                                          ...
                                          <a href="<?php echo e(route('mybill')); ?>" class="iq-sub-card iq-bg-primary-hover">
                                             <div class="media align-items-center">
                                                <div class="rounded iq-card-icon iq-bg-primary">
         ...
         </div><?php /**PATH C:\xampp\htdocs\qlnhasach\resources\views/layout/header.blade.php ENDPATH**/ ?>