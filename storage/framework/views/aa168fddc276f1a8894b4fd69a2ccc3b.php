                ...
                <div class="row m-0">
                    <div class="col-sm-12 sign-in-page-data">
                        <div class="sign-in-from bg-primary rounded">
                            ...
                            <form class="mt-4 form-text" action="<?php echo e(route('postSignup')); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="sign-info text-center">
                                    ...
                                    <span class="text-dark d-inline-block line-height-2">Đã có tài khoản? <a href="<?php echo e(route('admin.getLogin')); ?>" class="text-white">Đăng nhập</a></span>
                                </div>
                            </form>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\qlnhasach\resources\views/product/sign-up.blade.php ENDPATH**/ ?>